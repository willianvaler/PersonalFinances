<%-- 
    ...
    Created on : 18/09/2016, 15:16:31
    Author     : willian
--%>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table order-table">
                                    ...
                                    <tbody>
                                        <%
                                            List<Categoria> categorias = new CategoryManagerDAO().select();
                                        ...
                                        <tr>
                                            ...
                                            <td><%=c.getNome()%></td>
                                            <td><a href="Servlet?param=editCategory&id=<%=c.getIdcategoria()%>">Editar</a></td>
                                            <td><a OnClick="return confirm('Confirma exclusão?')" href="Servlet?param=delCategory&id=<%=c.getIdcategoria()%>">Excluir</a></td>
                                        </tr>
                                        <%
                                            }
                                        %>
